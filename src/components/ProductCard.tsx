...
const ProductCard = React.memo(({ product }: ProductCardProps) => {
  ...
  const getPrice = React.useCallback(() => {
    ...
    switch (supportType) {
      ...
      case "petit-tote-bag": supportPrice = 5.00; break;
      case "tote-bag": supportPrice = 8.00; break;
      case "backpack": supportPrice = 8.00; break;
    ...
    <div className="korean-card p-8 group hover-glow">
      <div className="relative mb-6 overflow-hidden rounded-xl">
        ...
        <div className="space-y-2">
            ...
            <div className="relative overflow-hidden rounded-lg">
              <Dialog>
                <DialogTrigger asChild>
                  <div className="cursor-pointer hover:scale-105 transition-transform duration-300">
                    <img 
                      src={product.id === 'preprinted-chibis' ? "/lovable-uploads/f6.jpg" : "/lovable-uploads/d2de6ccb-7f9f-48ee-98e2-e27d6ac9e635.png"}
          ...
          {/* Bottom row - additional images for custom chibis only */}
          ...
          {/* Bottom row - additional images for preprinted chibis only */}
            ...
            <div className="mb-6">
              ...
              <Select value={supportType} onValueChange={setSupportType}>
                ...
                <SelectContent className="bg-white border-2 border-korean-gold/20 z-50">
                  ...
                  <SelectItem value="petit-tote-bag" className="hover:bg-korean-gold/10">{t('shop.petitToteBag')} (+5.00€)</SelectItem>
                  <SelectItem value="tote-bag" className="hover:bg-korean-gold/10">{t('shop.toteBag')} (+8.00€)</SelectItem>
                  <SelectItem value="backpack" className="hover:bg-korean-gold/10">{t('shop.backpack')} (+8.00€)</SelectItem>
