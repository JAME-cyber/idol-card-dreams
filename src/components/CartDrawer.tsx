      ...
      <div className="absolute right-0 top-0 h-full w-full max-w-md bg-white shadow-xl">
        <div className="flex h-full flex-col">
          ...
          <div className="flex items-center justify-between border-b p-4">
            <h2 className="text-xl font-bold font-poppins">{getText('cart')}</h2>
            <button
              onClick={onClose}
          ...
          <div className="flex-1 overflow-y-auto p-4">
            {items.length === 0 ? (
              <div className="text-center py-12">
                <p className="text-stone-black/60 font-korean">{getText('empty')}</p>
              </div>
            ) : (
            ...
            <div className="border-t p-4 space-y-3">
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  <span className="font-medium font-korean">{getText('subtotal')}:</span>
                  <span className="font-bold text-stone-black">€{total.toFixed(2)}</span>
                </div>
                {shippingCost !== null && (
                  <div className="flex justify-between items-center">
                    <span className="font-medium font-korean">{getText('shipping')}:</span>
                    <span className="font-bold text-korean-gold">
                      {shippingCost === 0 ? getText('freeShipping') : `€${shippingCost.toFixed(2)}`}
                    </span>
                  </div>
                ...
                <div className="flex justify-between items-center">
                  <span className="text-lg font-bold font-poppins">{getText('total')}:</span>
