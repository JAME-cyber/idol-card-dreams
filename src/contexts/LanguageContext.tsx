...
const translations = {
  en: {
    ...
    'hero.originalWay': 'Here is an original way to never forget them!',
    'hero.personalDescription': 'Tell me which ones are your favorites, I can create your box. It will be unique, handmade and according to your preferences!',
    ...
    'hero.callToAction': 'And you, which Kdramas do you want to remember forever?',
    ...
    'shop.mochisBoxName': 'My Mochi Box',
    ...
    'shop.shippingIncluded': 'Shipping included',
  ...
  fr: {
    ...
    // Hero Section
    'hero.title': 'Mini Kdrama Mochis',
    'hero.subtitle': 'Crée Ta Mochi Box avec tes Kdramas préférés!',
    'hero.tagline': 'Ta Mochi Box sera unique!',
    ...
    'hero.originalWay': 'Voici une façon originale de ne pas les oublier!',
    'hero.personalDescription': 'Dis moi quels sont tes préférés, je pourrai créer ta boite. Elle sera unique, faite main et en fonction de tes préférences!',
    ...
    'hero.callToAction': 'Toi, de quels Kdramas veux-tu te souvenir pour toujours?',
    'hero.boxDescription': 'Chaque Mochi Box est accompagnée de son descriptif avec Référence de la série, acteurs principaux et année.',
    ...
    // Shop Section
    'shop.title': 'Mini Kdrama Mochis',
    'shop.subtitle': 'Crée Ta Mochi Box unique!',
    'shop.mochisBoxName': 'Ma Mochi Box',
    'shop.mochisBoxDesc': '9 Mochis uniques inspirés de tes Kdramas préférés, avec carte descriptive',
    'shop.kdramaChoicesLabel': 'Quels Kdramas veux-tu dans Ta Mochi Box? (9 choix)',
    ...
    'shop.kdramaRequiredMessage': 'Merci d\'indiquer tes 9 Kdramas préférés pour créer Ta Mochi Box personnalisée.',
    'shop.quantity': 'Quantité',
    'shop.addToCart': 'Ajouter au Panier',
    'shop.giftCardName': 'Bon Cadeau',
    'shop.giftCardDesc': 'Offre une Mochi Box personnalisée! Le destinataire choisira ses 9 Kdramas préférés.',
    ...
    'shop.shippingIncluded': 'Livraison incluse',
  ...
  ko: {
    ...
    'hero.originalWay': '그들을 잊지 않는 독특한 방법이 있어!',
    'hero.personalDescription': '좋아하는 드라마가 뭔지 말해줘, 너만의 박스를 만들어줄게. 손으로 직접 만들고 네 취향에 맞춰 유일무이한 박스가 될 거야!',
    ...
    'hero.callToAction': '너는 어떤 K드라마를 영원히 기억하고 싶어?',
