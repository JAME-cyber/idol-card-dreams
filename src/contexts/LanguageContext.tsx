...
const translations = {
  en: {
    ...
    'hero.noteDescription': 'Which Kdramas do you want to remember forever?',
  ...
  fr: {
    ...
    'hero.noteDescription': 'De quels Kdramas veux-tu te souvenir pour toujours?',
  ...
  ko: {
    ...
    'hero.noteDescription': '어떤 K드라마를 영원히 기억하고 싶어?',
